...
if (os.ios) {
    /*ios 下载链接*/
    url = "https://apps.apple.com/cn/app/%E5%AE%89%E5%BF%83%E5%AE%A0%E7%89%A9%E6%89%98%E8%BF%90/id1535254811";
    // location.href = url;
} else if (os.android) {
    url = "https://devmodu.com/pet_relocation/app-release.apk";
} else {
    url = null;
}
...
if (os.android) {
    ...
    divDownload.innerHTML = "<a href=" + url + ">下载体验</a>";
} else if (os.ios) {
